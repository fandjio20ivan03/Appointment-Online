...
export class PageRendezVousComponent implements OnInit {
  ...
  constructor(private dataService: DataService, private calendrierservice: CalenderService, private router: Router) {}
  ...
  chargerCalendrier(rep: number) {
    ...
    if (this.calendrier_data.length !== 0) {
          ...
          this.calendrier_data.forEach((data: any) => {
            ...
            this.calendrierservice.insertDataCalendrier(this.calendrier).subscribe(res => {
